package tech.msop.core.cloud.hystrix;
 ...
 */
@AllArgsConstructor
public class MsHystrixConcurrencyStrategy extends HystrixConcurrencyStrategy {
    @Nullable
    ...
    public <T> Callable<T> wrapCallable(Callable<T> callable) {
        return  existingConcurrencyStrategy != null
                ? existingConcurrencyStrategy.wrapCallable(callable)
