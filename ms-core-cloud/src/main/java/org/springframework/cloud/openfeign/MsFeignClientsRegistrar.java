...
import com.msop.core.cloud.hystrix.MsHystrixAutoConfiguration;
 ...
 */
@NoArgsConstructor
public class MsFeignClientsRegistrar implements ImportBeanDefinitionRegistrar, BeanClassLoaderAware, EnvironmentAware {
    @Getter
    ...
    private Class<?> getSpringFactoriesLoaderFactoryClass() {
        return MsHystrixAutoConfiguration.class;
    }
