...
public class CustomRedisTokenStore implements TokenStore {
    ...
    public CustomRedisTokenStore(RedisConnectionFactory connectionFactory, MsSecurityProperties securityProperties, RedisSerializer<Object> redisValueSerializer) {
