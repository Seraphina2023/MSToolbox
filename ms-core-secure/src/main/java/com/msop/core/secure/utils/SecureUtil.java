...
import com.msop.core.common.constant.RoleConstant;
import com.msop.core.common.constant.StringConstant;
import com.msop.core.common.utils.*;
...
public class SecureUtil {
    ...
    private static final String BASE64_SECUREITY = Base64.getEncoder().encodeToString(TokenConstant.SIGN_KEY.getBytes(StandardCharsets.UTF_8));
