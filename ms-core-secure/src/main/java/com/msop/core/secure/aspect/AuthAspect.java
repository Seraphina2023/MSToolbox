package com.msop.core.secure.aspect;

import com.msop.core.common.model.CodeEnum;
import com.msop.core.common.utils.ClassUtil;
import com.msop.core.common.utils.StringUtil;
import com.msop.core.secure.annotation.PreAuth;
import com.msop.core.secure.auth.AuthFun;
...
public class AuthAspect implements ApplicationContextAware {
     ...
     */
    @Around(
            "@annotation(com.msop.core.secure.annotation.PreAuth) || " +
                    "@within(com.msop.core.secure.annotation.PreAuth)"
    )
    public Object preAuth(ProceedingJoinPoint point) throws Throwable {
        if (handleAuth(point)) {
            return point.proceed();
        }
        throw new SecureException(CodeEnum.UN_AUTHORIZED);
    }
