...
import static com.msop.core.cache.constant.CacheConstant.SYS_CACHE;

/**
 * 默认scope model handler
 *
 * @author ruozhuliufeng
 */
@RequiredArgsConstructor
public class MsScopeModelHandler implements ScopeModelHandler {
    ...
    public DataScopeModel getDataScopeByMapper(String mapperId, String roleId) {
        ...
        // 后续若有新增配置则会清空缓存重新加载
        DataScopeModel dataScope = CacheUtil.get(SYS_CACHE, SCOPE_CACHE_CLASS, mapperId + StringConstant.COLON + roleId, DataScopeModel.class, Boolean.FALSE);
        if (dataScope == null || !dataScope.getSearched()) {
            ...
            CacheUtil.put(SYS_CACHE, SCOPE_CACHE_CLASS, mapperId + StringConstant.COLON + roleId, dataScope, Boolean.FALSE);
        }
