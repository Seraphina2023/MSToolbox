 ...
 */
public class MsXssHttpServletRequestWrapper extends HttpServletRequestWrapper {
    ...
    private final static MsXssHtmlFilter HTML_FILTER = new MsXssHtmlFilter();

    public MsXssHttpServletRequestWrapper(HttpServletRequest request) {
        super(request);
        orgRequest = request;
    }
